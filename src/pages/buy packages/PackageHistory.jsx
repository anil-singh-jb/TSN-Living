    ...
    return (
        ...
        <>
            <div className="main-content-box" style={{ display: "flex", flexDirection: "column", minHeight: "88vh" }}>
                <h2 className="page-title">Package History</h2>
                <div className="main-serch-box">
                    ...
                    >
                        ...
                        /
                        <p style={{ color: "white" }}>Package History</p>
                    </Breadcrumbs>
                </div>
                ...
                <Box className="main-table-card">
                    ...
                    <Box style={{ display: "flex", justifyContent: "space-between", alignItems: "center"}}>
                        <h2 className="table-title">All Package History</h2>
                    </Box>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell className="table-body-cell">Package 2</TableCell>
                                ...
                                <TableRow>
                                    ...
                                    <TableCell className="table-body-cell">Package 1</TableCell>
                                    <TableCell className="table-body-cell">20/02/2025</TableCell>
                                    <TableCell className="table-body-cell">
                                        Active
                                    </TableCell>
